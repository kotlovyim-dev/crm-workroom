...
from app.features.employees.services import EmployeesService
from app.features.shared.dependencies import AuthContext
from app.features.shared.domain_support import DomainSupport
from app.features.shared.models import Employee, TimeOffRequest
...
class VacationsService(DomainSupport):
